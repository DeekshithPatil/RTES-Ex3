...
/*
Ans: Deadlock can be avoided by removing or commenting the line: if(!nowait)usleep(1000000) in both threads.
     Then, the thread that gets spawned first will get access to both mutexes, and release them on completion.  
     The second thread then accesses both of them
*/
